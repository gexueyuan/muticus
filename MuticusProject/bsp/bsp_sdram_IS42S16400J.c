/*****************************************************************************
 ...
 @file   : bsp_sdram_IS42S16400J.c
 @brief  : This file include the bsp functions for the sdram module IS42S16400J.
 @author : wangxianwen
 @history:
...
/* Includes -----------------------------------------------------------------*/
#include "bsp_sdram_IS42S16400J.h"
...
static void SDRAM_ModuleInit(void);
...
/**
  * @brief  Initialize all SDRAM memory I/Os pins. 
  * @param  None. 
  * @retval None.
  */
static void SDRAM_GPIOInit(void)
...
static void SDRAM_ModuleInit(void)
{
    FMC_SDRAMCommandTypeDef FMC_SDRAMCommandStructure = { 0 };
    uint32_t                     tmpr = 0;
...
void SDRAM_Init(void)
{
    ...
    /* FMC module configuration in MCU. */
    SDRAM_FMCInit();
