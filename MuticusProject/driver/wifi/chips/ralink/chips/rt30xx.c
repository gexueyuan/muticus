...
*/
const REG_PAIR   RT3020_RFRegTable[] = {
        {RF_R04,          0x40},
        {RF_R05,          0x03},
        {RF_R06,          0x02},
        {RF_R07,          0x60},      
...
const UCHAR NUM_RF_3020_REG_PARMS = (sizeof(RT3020_RFRegTable) / sizeof(REG_PAIR));
    ...
    IN BOOLEAN                    bScan)
{
    ...
    */
    ...
    RT30xx_RTMPSetAGCInitValue(pAd, BW_20);
    ...
    IN PRTMP_ADAPTER        pAd)
{
    ...
    */
    pChipCap->pRFRegTable = (REG_PAIR*)RT3020_RFRegTable;
    ...
    if((IS_RT3070(pAd) || IS_RT3071(pAd)) || IS_RT3090(pAd))
    {
        ...
        pChipOps->AsicHaltAction = 0;//RT30xxHaltAction;
        pChipOps->AsicRfTurnOff = 0;//RT30xxLoadRFSleepModeSetup;
        pChipOps->AsicReverseRfFromSleepMode = 0;//RT30xxReverseRFSleepModeSetup;
