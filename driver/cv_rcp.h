...
typedef enum _DSRC_MSG_ID 
{
	...
	DSRCmsgID_commonSafetyRequest	      = 4,  /* CSR */
	DSRCmsgID_emergencyVehicleAlert	      = 5,  /* EVA */
	DSRCmsgID_intersectionCollisionAlert  = 6,  /* ICA */
	DSRCmsgID_mapData	                  = 7,  /* MAP, GID, intersections */
	DSRCmsgID_nmeaCorrections	          = 8,  /* NMEA */
	DSRCmsgID_probeDataManagement	      = 9,  /* PDM */
	DSRCmsgID_probeVehicleData	          = 10, /* PVD */
	DSRCmsgID_roadSideAlert	              = 11, /* RSA */
	DSRCmsgID_rtcmCorrections             = 12, /* RTCM */
	DSRCmsgID_signalPhaseAndTimingMessage = 13, /* APAT */
	DSRCmsgID_signalRequestMessage	      = 14, /* SRM */
	DSRCmsgID_signalStatusMessage	      = 15, /* SSM */
	DSRCmsgID_travelerInformation	      = 16  /* TIM */
	/*
 ...
 *      The sentence "typedef __packed struct xxx" alse can working in this IDE.
 *
 * */
...
}rcp_msg_basic_safty_t, *rcp_msg_basic_safty_t_ptr;

#define RCP_MSG_BASIC_SAFTY_T_LEN    (sizeof(rcp_msg_basic_safty_t))
