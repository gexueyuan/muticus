...
#define RT28xx_EEPROM_READ16(_pAd, _offset, _value)            \
    RTUSBReadEEPROM16((RTMP_ADAPTER *)(_pAd), (USHORT)(_offset), (PUSHORT)&(_value))

#define RT28xx_EEPROM_WRITE16(_pAd, _offset, _value)        \
    RTUSBWriteEEPROM16((RTMP_ADAPTER *)(_pAd), (USHORT)(_offset), (USHORT)(_value))
...
typedef int (*eeinit_def)(struct _RTMP_ADAPTER *pAd);
...
extern const UCHAR NUM_OF_3020_CHNL;
extern const FREQUENCY_ITEM * const FreqItems3020;
extern const RTMP_RF_REGS RF2850RegTable[];
extern const UCHAR NUM_OF_2850_CHNL;
